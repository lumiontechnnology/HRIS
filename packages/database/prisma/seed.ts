...
async function main(): Promise<void> {
  ...
  const payrollComponents = [
    { name: 'Basic Salary', code: 'BASIC', type: 'BASIC', frequency: 'FIXED', isTaxable: true, isPensionable: true, isNhf: true, sortOrder: 1 },
    { name: 'Housing Allowance', code: 'HOUSING', type: 'ALLOWANCE', frequency: 'FIXED', isTaxable: false, isPensionable: false, isNhf: false, sortOrder: 2 },
    { name: 'Transport Allowance', code: 'TRANSPORT', type: 'ALLOWANCE', frequency: 'FIXED', isTaxable: false, isPensionable: false, isNhf: false, sortOrder: 3 },
    { name: 'Utility Allowance', code: 'UTILITY', type: 'ALLOWANCE', frequency: 'FIXED', isTaxable: false, isPensionable: false, isNhf: false, sortOrder: 4 },
    { name: 'Special Allowance', code: 'SPECIAL', type: 'ALLOWANCE', frequency: 'FIXED', isTaxable: false, isPensionable: false, isNhf: false, sortOrder: 5 },
    { name: 'Extra Pay', code: 'EXTRA_PAY', type: 'EXTRA_PAY', frequency: 'VARIABLE', isTaxable: false, isPensionable: false, isNhf: false, sortOrder: 6 },
    { name: 'Performance Bonus', code: 'BONUS', type: 'BONUS', frequency: 'VARIABLE', isTaxable: true, isPensionable: false, isNhf: false, sortOrder: 7 },
    { name: '13th Month Allowance', code: 'THIRTEENTH_MONTH', type: 'BONUS', frequency: 'VARIABLE', isTaxable: true, isPensionable: false, isNhf: false, sortOrder: 8 },
    { name: 'Overtime Pay', code: 'OVERTIME', type: 'OVERTIME', frequency: 'VARIABLE', isTaxable: true, isPensionable: true, isNhf: false, sortOrder: 9 },
  ] as const;
  ...
  for (const component of payrollComponents) {
    await prisma.$executeRawUnsafe(
      `INSERT INTO payroll_components (
          ...
          display_on_payslip, sort_order, created_by, created_at, updated_at
        ) VALUES ($1, $2, $3, $4, $5::component_type, $6::component_frequency, $7, $8, $9, true, $10, $11, now(), now())
        ...
        DO UPDATE SET
          ...
          is_pensionable = EXCLUDED.is_pensionable,
          is_nhf_applicable = EXCLUDED.is_nhf_applicable,
          sort_order = EXCLUDED.sort_order,
          updated_at = now()`,
      `pc_${tenant.id}_${component.code}`,
      tenant.id,
      component.name,
      component.code,
      component.type,
  ...
  const seededEmployeesForPayroll = [
    ctoEmployee,
    seniorEngineer1,
    seniorEngineer2,
    hrManager,
  ...
  console.log('Seeded payroll components and basic salary assignments');
