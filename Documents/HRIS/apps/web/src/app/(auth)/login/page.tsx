...
export default function LoginRoutePage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    if (savedEmail) {
      // Keep behavior parity with sign-in route. Component owns field state, this just preserves preference state.
